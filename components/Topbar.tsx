...
export default function Topbar(props: Props) {
  ...
  return (
    <div
      ...
      } transition-all duration-300 p-2 bg-[#15406A] z-40`}
    >
      <div className="flex justify-between items-center sm:pt-3 transition-all duration-300">
        ...
        <div className="sm:block hidden sm:px-5 px-0">
          <ul className="flex">
            <li className="flex items-center px-4 py-2 gap-1 hover:bg-blue-300 duration-200 transition-all rounded hover:text-black text-white">
              <FaHome className="text-lg" />
              <a href="/main/dashboard" className="block">
                Beranda
              </a>
            </li>
            <li className="flex items-center px-4 py-2 gap-1 hover:bg-blue-300 duration-200 transition-all rounded hover:text-black text-white">
              <FaUserFriends className="text-lg text-white" />
              <a href="/main/debtor/list" className="block text-white">
                Data Debitur
              </a>
            </li>
            <li className="flex items-center px-4 py-2 gap-1 hover:bg-blue-300 duration-200 transition-all rounded hover:text-black text-white">
              <FaMoneyBill className="text-lg text-white" />
              <a href="/main/payment/list" className="block text-white">
                Data Transaksi
              </a>
            </li>
            <li className="flex items-center px-4 py-2 gap-1 hover:bg-blue-300 duration-200 transition-all rounded hover:text-black text-white">
              <FaUser className="text-lg text-white" />
              <a href="/main/user/list" className="block text-white">
                Pengguna
              </a>
            </li>
            <li className="flex items-center px-4 py-2 gap-1 hover:bg-blue-300 duration-200 transition-all rounded hover:text-black text-white">
      ...
      <div className={`${open ? "block" : "hidden"}`} id="dropdown-menu">
        <ul>
          <li className="flex items-center px-4 py-2 gap-1">
            ...
            <a href="/main/dashboard" className="block text-white">
              Beranda
            </a>
          </li>
          <li className="flex items-center px-4 py-2 gap-1">
